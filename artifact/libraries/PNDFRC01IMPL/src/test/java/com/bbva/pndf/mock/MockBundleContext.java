...
public class MockBundleContext implements BundleContext,
	...
	public Bundle getBundle() {
		...
		Mockito.when(mockBundle.getSymbolicName()).thenReturn("PNDFRC01IMPL-2.0.23");
		Mockito.when(mockBundle.getVersion()).thenReturn(new Version("2.0.23"));
		return mockBundle;
	}
